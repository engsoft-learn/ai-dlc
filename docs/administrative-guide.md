...
**Download:** [administrative-guide.pdf](pdf/administrative-guide.pdf)
...
- [Developer's Guide](developers-guide.md) — Running builds locally (CodeBuild + `act`)
...
For detailed remediation and suppression instructions, see [Developer's Guide — Security Scanners](developers-guide.md#security-scanners).
...
For detailed remediation and suppression instructions per scanner, see [Developer's Guide — Security Scanners](developers-guide.md#security-scanners).
